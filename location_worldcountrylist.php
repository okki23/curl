...
foreach ($data as $key => $value) {
    ...
    echo "insert into temp_location_worldcountrylist (country_id,name,continent,region,local_name,flag_url) values ('".$value['country_id']."','".$value['name']."','".$value['continent']."','".$value['region']."','".$value['local_name']."','".$value['flag_url']."');";
