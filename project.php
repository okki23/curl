...
$data = array("key" => "170802052520k704a4ea1b924837dc639307650e27e34354317558",
              "scope" => "project",
              "operation" => "select",
              "data" => array("page" => 79, "fields" => ["companyId","projectId","departmentId","responsibleUserId","name","description","categoryId","statusId","percentCompleted","invoiceNotes","startDate","endDate","created","updated"]));
